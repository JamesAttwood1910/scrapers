...
class_search = "c-entry-box--compact__title"
...
divs = soup.find_all("h2", class_ = class_search)
...
df['source_name'] = "Eater"

df['source_website'] = "https://www.eater.com/"
...
df.to_json("daily_articles_eater.json", orient = 'records')

daily_save_name = "daily_articles/json/eater/" + "daily_articles_eater" + today + ".json"
...
with open("daily_articles_eater.json") as file:
...
for record in Collection.find({'source':'eater', 'date':today}):
    print(record) 
